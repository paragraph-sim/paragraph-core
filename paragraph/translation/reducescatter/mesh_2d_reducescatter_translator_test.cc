...
inner_subroutines {
  ...
  instructions {
    ...
    inner_subroutines {
      ...
      instructions {
        name: "reduce-scatter_stream-0_stage-1_mesh-1d_cw_sendrecv_1"
        opcode: "sendrecv"
        instruction_id: 26
        bytes_in: 10
        bytes_out: 10
      ...
      instructions {
        name: "reduce-scatter_stream-0_stage-1_mesh-1d_cw_reduction_1"
        opcode: "call"
        instruction_id: 27
        operand_ids: 26
        inner_subroutines {
      ...
      instructions {
        name: "reduce-scatter_stream-0_stage-1_mesh-1d_ccw_send_2"
        opcode: "send"
        instruction_id: 32
        bytes_out: 10
        communication_groups {
  ...
  instructions {
    ...
    inner_subroutines {
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_root_0"
        opcode: "null"
        instruction_id: 50
        operand_ids: 46
        operand_ids: 41
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_ccw_send_1"
        opcode: "send"
        instruction_id: 51
        bytes_out: 10
        communication_groups {
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_cw_sendrecv_1"
        opcode: "sendrecv"
        instruction_id: 52
        bytes_in: 10
        bytes_out: 10
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_cw_reduction_1"
        opcode: "call"
        instruction_id: 53
        operand_ids: 52
        inner_subroutines {
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_root_1"
        opcode: "null"
        instruction_id: 57
        operand_ids: 53
        operand_ids: 51
      ...
      instructions {
        name: "reduce-scatter_stream-1_stage-1_mesh-1d_ccw_send_2"
        opcode: "send"
        instruction_id: 58
        bytes_out: 10
        communication_groups {
